...
def test_account_page_in_constructor(driver):
    WebDriverWait(driver, 10).until(
        expected_conditions.presence_of_element_located((TestLocators.BUTTON_ACCOUNT)))
    driver.find_element(*TestLocators.BUTTON_ACCOUNT).click()
    driver.find_element(*TestLocators.INPUT_LOGIN).clear()
    ...
    driver.find_element(*TestLocators.BUTTON_ACCOUNT).click()
    WebDriverWait(driver, 10).until(
        expected_conditions.presence_of_element_located((TestLocators.BUTTON_CONSTRUCTOR)))
...
def test_account_page_in_baner(driver):
    WebDriverWait(driver, 10).until(
        expected_conditions.presence_of_element_located((TestLocators.BUTTON_ACCOUNT)))
    driver.find_element(*TestLocators.BUTTON_ACCOUNT).click()
    driver.find_element(*TestLocators.INPUT_LOGIN).clear()
    ...
    driver.find_element(*TestLocators.BUTTON_ACCOUNT).click()
    WebDriverWait(driver, 10).until(
        expected_conditions.presence_of_element_located((TestLocators.HEADER_BANNER)))
    driver.find_element(*TestLocators.HEADER_BANNER).click()
    header = driver.find_element(*TestLocators.TABLE_HEADER).text
    assert header == 'Соберите бургер'

def test_exit_account(driver):
    WebDriverWait(driver, 10).until(
        expected_conditions.presence_of_element_located((TestLocators.BUTTON_ACCOUNT)))
    driver.find_element(*TestLocators.BUTTON_ACCOUNT).click()
    driver.find_element(*TestLocators.INPUT_LOGIN).clear()
    ...
    driver.find_element(*TestLocators.BUTTON_ACCOUNT).click()
    WebDriverWait(driver, 10).until(
        expected_conditions.presence_of_element_located((TestLocators.BUTTON_EXIT)))
